------------------------------------------------
-- This Source Was Developed By (TRON) @JJJJJJTJ.--
...
local TheTRON = io.open("TheTRON", 'w')
TheTRON:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 TRON.lua
done
]])
TheTRON:close()
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S TheTRON -X kill
screen -S TheTRON ./TheTRON
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x TheTRON;chmod +x Run;./Run')
end
...
TheTRON = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..TheTRON)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=TheTRON,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,781397140}  
...
Status = 0
DevelopersQ = Redis:sismember(TheTRON.."TRON:DevelopersQ:Groups",UserId) 
if UserId == 781397140 then
Status = true
elseif UserId == 781397140 then
Status = true
elseif UserId == Sudo_Id then  
Status = true
elseif UserId == TheTRON then
Status = true
...
Status = 0
Developers = Redis:sismember(TheTRON.."TRON:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(TheTRON.."TRON:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(TheTRON.."TRON:TheBasics:Group"..ChatId,UserId)
TheBasicsQ = Redis:sismember(TheTRON.."TRON:TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(TheTRON.."TRON:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TheTRON.."TRON:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(TheTRON.."TRON:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(TheTRON.."TRON:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 5104699084 then
Status = 'مبرمج السورس'
elseif UserId == 781397140 then
Status = ' مطور السورس'
elseif UserId == Sudo_Id then  
...
Status = Redis:get(TheTRON.."TRON:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = Redis:get(TheTRON.."TRON:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(TheTRON.."TRON:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(TheTRON.."TRON:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(TheTRON.."TRON:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(TheTRON.."TRON:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(TheTRON.."TRON:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(TheTRON.."TRON:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(TheTRON.."TRON:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(TheTRON.."TRON:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(TheTRON.."TRON:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(TheTRON.."TRON:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(TheTRON.."TRON:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(TheTRON.."TRON:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(TheTRON.."TRON:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(TheTRON.."TRON:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TheTRON.."TRON:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(TheTRON.."TRON:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TheTRON.."TRON:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(TheTRON.."TRON:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(TheTRON.."TRON:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(TheTRON.."TRON:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TheTRON.."TRON:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(TheTRON.."TRON:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(TheTRON.."TRON:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(TheTRON.."TRON:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TheTRON.."TRON:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(TheTRON.."TRON:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(TheTRON.."TRON:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(TheTRON.."TRON:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TheTRON.."TRON:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(TheTRON.."TRON:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(TheTRON.."TRON:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(TheTRON.."TRON:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TheTRON.."TRON:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(TheTRON.."TRON:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(TheTRON.."TRON:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(TheTRON.."TRON:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TheTRON.."TRON:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(TheTRON.."TRON:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(TheTRON.."TRON:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(TheTRON.."TRON:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TheTRON.."TRON:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(TheTRON.."TRON:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(TheTRON.."TRON:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(TheTRON.."TRON:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TheTRON.."TRON:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(TheTRON.."TRON:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(TheTRON.."TRON:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(TheTRON.."TRON:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TheTRON.."TRON:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(TheTRON.."TRON:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(TheTRON.."TRON:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(TheTRON.."TRON:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TheTRON.."TRON:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(TheTRON.."TRON:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(TheTRON.."TRON:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(TheTRON.."TRON:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TheTRON.."TRON:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(TheTRON.."TRON:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(TheTRON.."TRON:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(TheTRON.."TRON:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TheTRON.."TRON:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(TheTRON.."TRON:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(TheTRON.."TRON:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(TheTRON.."TRON:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TheTRON.."TRON:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(TheTRON.."TRON:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(TheTRON.."TRON:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(TheTRON.."TRON:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TheTRON.."TRON:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(TheTRON.."TRON:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(TheTRON.."TRON:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(TheTRON.."TRON:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TheTRON.."TRON:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(TheTRON.."TRON:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(TheTRON.."TRON:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(TheTRON.."TRON:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TheTRON.."TRON:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(TheTRON.."TRON:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(TheTRON.."TRON:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(TheTRON.."TRON:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(TheTRON.."TRON:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(TheTRON.."TRON:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(TheTRON.."TRON:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TheTRON.."TRON:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(TheTRON.."TRON:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(TheTRON.."TRON:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(TheTRON.."TRON:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TheTRON.."TRON:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(TheTRON.."TRON:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(TheTRON.."TRON:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TheTRON.."TRON:SilentGroup:Group"..ChatId,UserId)
}
end
...
return {
Lock     = '[𝖲𝗈𝗎𝗋𝖼𝖾 TRON](https://https://t.me/JJJJJJTJ)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[𝖲𝗈𝗎𝗋𝖼𝖾 TRON](https://https://t.me/JJJJJJTJ)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[𝖲𝗈𝗎𝗋𝖼𝖾 TRON](https://https://t.me/JJJJJJTJ)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[𝖲𝗈𝗎𝗋𝖼𝖾 TRON](https://https://t.me/JJJJJJTJ)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[𝖲𝗈𝗎𝗋𝖼𝖾 TRON](https://https://t.me/JJJJJJTJ)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[𝖲𝗈𝗎𝗋𝖼𝖾 TRON](https://https://t.me/JJJJJJTJ)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,TheTRON).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(TheTRON..'TRON:Channel:Join')
if Channel then
...
if tonumber(msg.sender.user_id) == tonumber(TheTRON) then
...
if tonumber(msg.sender.user_id) == 5104699084 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 781397140 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'المطور الاساسي '
elseif Redis:sismember(TheTRON.."TRON:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(TheTRON.."TRON:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TheTRON.."TRON:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(TheTRON.."TRON:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(TheTRON.."TRON:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TheTRON.."TRON:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TheTRON.."TRON:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TheTRON.."TRON:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TheTRON.."TRON:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(TheTRON.."TRON:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TheTRON.."TRON:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(TheTRON.."TRON:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TheTRON.."TRON:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(TheTRON.."TRON:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TheTRON.."TRON:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(TheTRON) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TheTRON.."TRON:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(TheTRON.."TRON:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheTRON.."TRON:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(TheTRON.."TRON:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TheTRON.."TRON:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TheTRON) then
return false
end
local floods = Redis:hget(TheTRON.."TRON:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(TheTRON.."TRON:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(TheTRON.."TRON:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(TheTRON.."TRON:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(TheTRON.."TRON:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(TheTRON.."TRON:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(TheTRON.."TRON:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(TheTRON.."TRON:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(TheTRON.."TRON:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(TheTRON.."TRON:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheTRON.."TRON:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheTRON.."TRON:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheTRON.."TRON:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(TheTRON.."TRON:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(TheTRON.."TRON:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(TheTRON.."TRON:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(TheTRON.."TRON:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(TheTRON.."TRON:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(TheTRON.."TRON:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheTRON.."TRON:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(TheTRON.."TRON:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TheTRON.."TRON:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TheTRON.."TRON:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(TheTRON.."TRON:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(TheTRON.."TRON:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(TheTRON.."TRON:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(TheTRON.."TRON:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(TheTRON.."TRON:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(TheTRON.."TRON:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(TheTRON.."TRON:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(TheTRON.."TRON:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(TheTRON.."TRON:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(TheTRON.."TRON:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(TheTRON.."TRON:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(TheTRON.."TRON:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(TheTRON.."TRON:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(TheTRON.."TRON:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(TheTRON.."TRON:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(TheTRON.."TRON:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(TheTRON.."TRON:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(TheTRON..'TRON:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(TheTRON.."TRON:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(TheTRON.."TRON:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(TheTRON.."TRON:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(TheTRON.."TRON:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(TheTRON.."TRON:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(TheTRON.."TRON:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(TheTRON.."TRON:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(TheTRON.."TRON:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(TheTRON..'TRON:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(TheTRON..'TRON:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(TheTRON.."TRON:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(TheTRON.."TRON:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(TheTRON.."TRON:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(TheTRON..'TRON:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(TheTRON..'TRON:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(TheTRON.."TRON:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(TheTRON.."TRON:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(TheTRON.."TRON:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(TheTRON.."TRON:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(TheTRON.."TRON:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(TheTRON.."TRON:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(TheTRON.."TRON:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(TheTRON.."TRON:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(TheTRON..'TRON:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(TheTRON.."TRON:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(TheTRON.."TRON:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(TheTRON.."TRON:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(TheTRON.."TRON:Command:List:Group"..msg_chat_id,text)
...
Redis:del(TheTRON.."TRON:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(TheTRON.."TRON:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TheTRON.."TRON:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TheTRON.."TRON:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TheTRON.."TRON:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(TheTRON.."TRON:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TheTRON.."TRON:Command:Reids:Group:New"..msg_chat_id)
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(TheTRON.."TRON:Command:List:Group"..msg_chat_id,text)
Redis:del(TheTRON.."TRON:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(TheTRON.."TRON:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(TheTRON.."TRON:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(TheTRON.."TRON:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(TheTRON.."TRON:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(TheTRON.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheTRON.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(TheTRON.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(TheTRON.."TRON:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(TheTRON.."TRON:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheTRON.."TRON:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(TheTRON.."TRON:Group:Rules" .. msg_chat_id,text) 
Redis:del(TheTRON.."TRON:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(TheTRON.."TRON:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheTRON.."TRON:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(TheTRON.."TRON:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(TheTRON.."TRON:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheTRON.."TRON:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheTRON.."TRON:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheTRON.."TRON:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheTRON.."TRON:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(TheTRON.."TRON:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheTRON.."TRON:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(TheTRON.."TRON:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(TheTRON.."TRON:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(TheTRON.."TRON:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(TheTRON.."TRON:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ رد للمدير بنجاح \n᥀︙ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(TheTRON.."TRON:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheTRON.."TRON:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(TheTRON.."TRON:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(TheTRON.."TRON:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(TheTRON.."TRON:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(TheTRON.."TRON:List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '𝖲𝗈𝗎𝗋𝖼𝖾 TRON ⁦', url='https://https://t.me/JJJJJJTJ'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(TheTRON.."TRON:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(TheTRON.."TRON:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheTRON.."TRON:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheTRON.."TRON:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(TheTRON.."TRON:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(TheTRON.."TRON:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(TheTRON.."TRON:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(TheTRON.."TRON:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(TheTRON.."TRON:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(TheTRON.."TRON:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(TheTRON.."TRON:Add:Rd:Sudo:Video"..text)
local document = Redis:get(TheTRON.."TRON:Add:Rd:Sudo:File"..text)
local audio = Redis:get(TheTRON.."TRON:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(TheTRON.."TRON:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheTRON..'TRON:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(TheTRON..'TRON:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(TheTRON.."TRON:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(TheTRON.."TRON:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(TheTRON.."TRON:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(TheTRON.."TRON:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(TheTRON.."TRON:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(TheTRON.."TRON:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(TheTRON.."TRON:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(TheTRON.."TRON:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(TheTRON.."TRON:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(TheTRON.."TRON:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheTRON..'TRON:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TheTRON.."TRON:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TheTRON.."TRON:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheTRON.."TRON:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheTRON.."TRON:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheTRON.."TRON:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(TheTRON.."TRON:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheTRON.."TRON:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(TheTRON.."TRON:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheTRON.."TRON:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(TheTRON.."TRON:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(TheTRON.."TRON:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(TheTRON.."TRON:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(TheTRON.."TRON:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheTRON.."TRON:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(TheTRON.."TRON:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TheTRON.."TRON:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TheTRON.."TRON:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(TheTRON..'TRON:'..v..text)
end
Redis:del(TheTRON.."TRON:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheTRON.."TRON:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(TheTRON.."TRON:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheTRON.."TRON:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheTRON.."TRON:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(TheTRON.."TRON:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(TheTRON.."TRON:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(TheTRON.."TRON:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(TheTRON.."TRON:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(TheTRON.."TRON:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(TheTRON.."TRON:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(TheTRON.."TRON:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(TheTRON.."TRON:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(TheTRON.."TRON:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheTRON.."TRON:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheTRON.."TRON:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(TheTRON..'TRON:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheTRON.."TRON:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheTRON.."TRON:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheTRON.."TRON:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheTRON.."TRON:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheTRON.."TRON:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheTRON.."TRON:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheTRON.."TRON:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(TheTRON..'TRON:GetTexting:DevTheTRON'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(TheTRON..'TRON:GetTexting:DevTheTRON'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم الغاء حفظ كليشة المطور')
end
Redis:set(TheTRON..'TRON:Texting:DevTheTRON',text)
Redis:del(TheTRON..'TRON:GetTexting:DevTheTRON'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم حفظ كليشة المطور')
end
if Redis:get(TheTRON.."TRON:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ᥀︙ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(TheTRON.."TRON:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheTRON.."TRON:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheTRON.."TRON:Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ᥀︙ تم تعين الايدي عام',"md",true)  
end
if Redis:get(TheTRON.."TRON:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء امر تعين الايدي","md",true)  
Redis:del(TheTRON.."TRON:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheTRON.."TRON:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheTRON.."TRON:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(TheTRON.."TRON:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheTRON.."TRON:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(TheTRON.."TRON:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(TheTRON.."TRON:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "᥀︙ تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(TheTRON.."TRON:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheTRON.."TRON:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(TheTRON.."TRON:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(TheTRON.."TRON:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "᥀︙ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(TheTRON.."TRON:Game:Smile"..msg.chat_id) then
if text == Redis:get(TheTRON.."TRON:Game:Smile"..msg.chat_id) then
Redis:incrby(TheTRON.."TRON:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheTRON.."TRON:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - سمايل او سمايلات","md",true)  
end
end 
if Redis:get(TheTRON.."TRON:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(TheTRON.."TRON:Game:Monotonous"..msg.chat_id) then
Redis:del(TheTRON.."TRON:Game:Monotonous"..msg.chat_id)
Redis:incrby(TheTRON.."TRON:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - الاسرع او ترتيب","md",true)  

end
end 
if Redis:get(TheTRON.."TRON:Game:Riddles"..msg.chat_id) then
if text == Redis:get(TheTRON.."TRON:Game:Riddles"..msg.chat_id) then
Redis:incrby(TheTRON.."TRON:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheTRON.."TRON:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - حزوره","md",true)  

end
end
if Redis:get(TheTRON.."TRON:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(TheTRON.."TRON:Game:Meaningof"..msg.chat_id) then
Redis:incrby(TheTRON.."TRON:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheTRON.."TRON:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - معاني","md",true)  

end
end
if Redis:get(TheTRON.."TRON:Game:Reflection"..msg.chat_id) then
if text == Redis:get(TheTRON.."TRON:Game:Reflection"..msg.chat_id) then
Redis:incrby(TheTRON.."TRON:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheTRON.."TRON:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - العكس","md",true)  

end
end
if Redis:get(TheTRON.."TRON:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(TheTRON.."TRON:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TheTRON.."TRON:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheTRON.."TRON:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TheTRON.."TRON:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TheTRON.."TRON:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TheTRON.."TRON:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TheTRON.."TRON:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheTRON.."TRON:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TheTRON.."TRON:Game:Difference"..msg.chat_id) then
if text == Redis:get(TheTRON.."TRON:Game:Difference"..msg.chat_id) then 
Redis:del(TheTRON.."TRON:Game:Difference"..msg.chat_id)
Redis:incrby(TheTRON.."TRON:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheTRON.."TRON:Game:Example"..msg.chat_id) then
if text == Redis:get(TheTRON.."TRON:Game:Example"..msg.chat_id) then 
Redis:del(TheTRON.."TRON:Game:Example"..msg.chat_id)
Redis:incrby(TheTRON.."TRON:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheTRON..'TRON:Channel:Join')}, },}}
...
if tonumber(TheTRON) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(TheTRON..'TRON:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TheTRON.."TRON:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TheTRON.."TRON:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheTRON.."TRON:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheTRON.."TRON:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheTRON.."TRON:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheTRON.."TRON:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(TheTRON) then 
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(TheTRON.."TRON:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TheTRON.."TRON:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheTRON.."TRON:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheTRON.."TRON:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TheTRON.."TRON:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(TheTRON..'TRON:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(TheTRON..'TRON:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,TheTRON).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(TheTRON..'TRON:Channel:Join',ChannelUser) 
...
Redis:set(TheTRON..'TRON:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheTRON..'TRON:Channel:Join')
...
download('https://raw.githubusercontent.com/iDAbdullah/TRON/main/TRON.lua','TRON.lua')
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(TheTRON..'TRON:Channel:Join:Name')..'', url = 't.me/'..Redis:get(TheTRON..'TRON:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'\n• يجب عليك الاشتراك في القناه',"md",false, false, false, false, reply_markup)
end
Redis:del(TheTRON.."TRON:SendBcBot") 
...
Redis:set(TheTRON.."TRON:SendBcBot",true) 
...
Redis:del(TheTRON.."TRON:LeftBot") 
...
Redis:set(TheTRON.."TRON:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ᥀︙ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(TheTRON.."TRON:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(TheTRON.."TRON:AddSudosNew"..msg_chat_id)
...
Redis:set(TheTRON.."TRON:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(TheTRON..'TRON:ChekBotAdd')  
local UsersBot = Redis:smembers(TheTRON..'TRON:Num:User:Pv')  
local Get_Json = '{"BotId": '..TheTRON..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(TheTRON.."TRON:TheBasics:Group"..v)
local Constructor = Redis:smembers(TheTRON.."TRON:Originators:Group"..v)
local Manager = Redis:smembers(TheTRON.."TRON:Managers:Group"..v)
local Admin = Redis:smembers(TheTRON.."TRON:Addictive:Group"..v)
local Vips = Redis:smembers(TheTRON.."TRON:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Get_Json = Get_Json..'"Dev":"JJJJJJTJ"}'
end
Get_Json = Get_Json..'}}'
...
listrep = Redis:smembers(TheTRON.."TRON:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TheTRON.."TRON:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TheTRON.."TRON:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TheTRON.."TRON:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TheTRON.."TRON:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TheTRON.."TRON:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TheTRON.."TRON:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TheTRON.."TRON:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TheTRON.."TRON:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TheTRON.."TRON:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TheTRON.."TRON:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TheTRON.."TRON:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TheTRON.."TRON:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TheTRON.."TRON:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TheTRON.."TRON:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TheTRON.."TRON:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TheTRON.."TRON:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TheTRON.."TRON:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TheTRON.."TRON:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TheTRON.."TRON:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TheTRON.."TRON:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TheTRON.."TRON:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TheTRON.."TRON:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TheTRON.."TRON:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TheTRON.."TRON:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TheTRON.."TRON:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TheTRON.."TRON:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TheTRON.."TRON:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TheTRON.."TRON:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(TheTRON..'TRON:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*᥀︙عدد احصائيات البوت الكامله \n— — — — — — — — —\n᥀︙عدد المجموعات : '..(Redis:scard(TheTRON..'TRON:ChekBotAdd') or 0)..'\n᥀︙عدد المشتركين : '..(Redis:scard(TheTRON..'TRON:Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(TheTRON.."TRON:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheTRON..'TRON:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheTRON..'TRON:Num:Add:Bot'),"md",true)  
end
...
{
{text = '𝖲𝗈𝗎𝗋𝖼𝖾 TRON', url = 'https://t.me/JJJJJJTJ'},
},
}
}
if not msg.ControllerBot then
...
Redis:sadd(TheTRON.."TRON:ChekBotAdd",msg_chat_id)
Redis:set(TheTRON.."TRON:Status:Id"..msg_chat_id,true) ;Redis:set(TheTRON.."TRON:Status:Reply"..msg_chat_id,true) ;Redis:set(TheTRON.."TRON:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TheTRON.."TRON:Status:BanId"..msg_chat_id,true) ;Redis:set(TheTRON.."TRON:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(TheTRON.."TRON:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheTRON.."TRON:ChekBotAdd",msg_chat_id) then
...
Redis:srem(TheTRON.."TRON:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TheTRON.."TRON:ChekBotAdd",msg_chat_id) then
Redis:incr(TheTRON..'TRON:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
if text == "ايدي" and msg.reply_to_message_id == 0 then
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheTRON..'TRON:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n᥀︙عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end 
if not Redis:get(TheTRON.."TRON:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(TheTRON..'TRON:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(TheTRON..'TRON:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(TheTRON.."TRON:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TheTRON.."TRON:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(TheTRON.."TRON:Set:Id:Group"..msg_chat_id)
if Redis:get(TheTRON.."TRON:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(TheTRON..'TRON:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(TheTRON..'TRON:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*᥀︙ايديه : '..UserId..
...
local TotalMsg = Redis:get(TheTRON..'TRON:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(TheTRON..'TRON:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*᥀︙ايديه : '..UserId..
'\n᥀︙معرفه : @'..UserName..
...
Redis:set(TheTRON.."TRON:Set:Id:Group"..msg.chat_id,Text_Rand)
...
{{text =news,url = "https://https://t.me/JJJJJJTJ"}, },}}
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,TheTRON).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,TheTRON).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(TheTRON.."TRON:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* ᥀︙تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheTRON.."TRON:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheTRON.."TRON:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheTRON.."TRON:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheTRON.."TRON:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheTRON.."TRON:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheTRON.."TRON:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheTRON.."TRON:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheTRON.."TRON:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheTRON.."TRON:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTRON.."TRON:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTRON.."TRON:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTRON.."TRON:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTRON.."TRON:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTRON.."TRON:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTRON.."TRON:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTRON.."TRON:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTRON.."TRON:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTRON.."TRON:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTRON.."TRON:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTRON.."TRON:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTRON.."TRON:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTRON.."TRON:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"* ᥀︙تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(TheTRON.."TRON:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:Developers:Groups",UserId) 
...
if not Redis:sismember(TheTRON.."TRON:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheTRON.."TRON:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheTRON.."TRON:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheTRON.."TRON:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheTRON.."TRON:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheTRON.."TRON:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheTRON.."TRON:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(TheTRON.."TRON:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(TheTRON.."TRON:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheTRON.."TRON:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheTRON.."TRON:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheTRON.."TRON:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheTRON.."TRON:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ᥀︙تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(TheTRON.."TRON:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheTRON.."TRON:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheTRON.."TRON:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheTRON.."TRON:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTRON.."TRON:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTRON.."TRON:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTRON.."TRON:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheTRON.."TRON:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTRON.."TRON:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTRON.."TRON:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTRON.."TRON:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTRON.."TRON:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTRON.."TRON:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ᥀︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(TheTRON.."TRON:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:Developers:Groups",UserId) 
...
if Redis:sismember(TheTRON.."TRON:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheTRON.."TRON:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheTRON.."TRON:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheTRON.."TRON:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheTRON.."TRON:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheTRON.."TRON:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(TheTRON.."TRON:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TheTRON.."TRON:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheTRON.."TRON:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheTRON.."TRON:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TheTRON.."TRON:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheTRON.."TRON:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(TheTRON.."TRON:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(TheTRON.."TRON:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*᥀︙قائمه مطورين البوت \n — — — — — — — — —*\n'
...
local Info_Members = Redis:smembers(TheTRON.."TRON:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTRON.."TRON:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTRON.."TRON:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTRON.."TRON:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTRON.."TRON:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTRON.."TRON:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTRON.."TRON:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTRON.."TRON:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheTRON.."TRON:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(TheTRON.."TRON:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(TheTRON.."TRON:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(TheTRON.."TRON:Status:Id"..msg_chat_id,true) 
...
Redis:set(TheTRON.."TRON:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(TheTRON.."TRON:Status:Reply"..msg_chat_id,true) 
...
Redis:set(TheTRON.."TRON:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(TheTRON.."TRON:Status:BanId"..msg_chat_id,true) 
...
Redis:set(TheTRON.."TRON:BotFree",true) 
...
Redis:set(TheTRON.."TRON:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(TheTRON.."TRON1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TheTRON.."TRON1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheTRON.."TRON1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheTRON.."TRON1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TheTRON.."TRON1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TheTRON..'TRON1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(TheTRON..'TRON1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(TheTRON..'TRON1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(TheTRON.."TRON1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheTRON.."TRON1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(TheTRON.."TRON1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(TheTRON.."TRON1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(TheTRON.."TRON1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(TheTRON.."TRON1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(TheTRON.."TRON1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(TheTRON.."TRON1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheTRON.."TRON1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheTRON.."TRON1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheTRON.."TRON1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheTRON.."TRON1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheTRON.."TRON1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheTRON.."TRON1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheTRON.."TRON1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheTRON.."TRON1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheTRON.."TRON1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheTRON.."TRON1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheTRON.."TRON1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheTRON.."TRON1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheTRON.."TRON1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(TheTRON.."TRON1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(TheTRON.."TRON1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(TheTRON.."TRON1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(TheTRON.."TRON11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(TheTRON.."TRON11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheTRON.."TRON11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheTRON.."TRON11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(TheTRON.."TRON11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(TheTRON..'TRON11:Add:Rd:Sudo:Text'..text)
Redis:del(TheTRON..'TRON11:Add:Rd:Sudo:Text1'..text)
Redis:del(TheTRON..'TRON11:Add:Rd:Sudo:Text2'..text)
Redis:del(TheTRON.."TRON11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheTRON.."TRON11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(TheTRON.."TRON11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TheTRON.."TRON11:Add:Rd:Sudo:Text"..v) 
Redis:del(TheTRON.."TRON11:Add:Rd:Sudo:Text1"..v) 
Redis:del(TheTRON.."TRON11:Add:Rd:Sudo:Text2"..v)   
Redis:del(TheTRON.."TRON11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(TheTRON.."TRON11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(TheTRON.."TRON11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheTRON.."TRON11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheTRON.."TRON11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheTRON.."TRON11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheTRON.."TRON11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(TheTRON.."TRON11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheTRON.."TRON11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheTRON.."TRON11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheTRON.."TRON11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(TheTRON.."TRON11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheTRON.."TRON11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheTRON.."TRON11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheTRON.."TRON11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(TheTRON.."TRON11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TheTRON.."TRON11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TheTRON.."TRON11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(TheTRON.."TRON:allM"..msg.chat_id, msg.id)
if Redis:get(TheTRON.."TRON:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(TheTRON.."TRON:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(TheTRON.."TRON:allM"..msg.chat_id)
...
Redis:del(TheTRON.."TRON:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(TheTRON.."TRON:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TheTRON.."TRON:allM"..msg.chat_id)  
...
Redis:del(TheTRON.."TRON:Status:Del:Media"..msg.chat_id)
...
Redis:set(TheTRON.."TRON:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(TheTRON.."TRON:Status:yt"..msg.chat_id)
...
Redis:set(TheTRON.."TRON:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(TheTRON.."TRON:Status:yt"..msg.chat_id) then
...
if TextMsg == 'الرابط' then
Redis:del(TheTRON.."TRON:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(TheTRON.."TRON:Status:Welcome"..msg_chat_id) 
...
Redis:del(TheTRON.."TRON:Status:Id"..msg_chat_id) 
...
Redis:del(TheTRON.."TRON:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(TheTRON.."TRON:Status:Reply"..msg_chat_id) 
...
Redis:del(TheTRON.."TRON:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(TheTRON.."TRON:Status:BanId"..msg_chat_id) 
...
Redis:del(TheTRON.."TRON:BotFree") 
...
Redis:del(TheTRON.."TRON:TwaslBot") 
...
if Redis:sismember(TheTRON.."TRON:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheTRON.."TRON:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(TheTRON.."TRON:BanAll:Groups",UserId_Info.id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 'https://t.me/JJJJJJTJ'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ᥀︙ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
if Redis:sismember(TheTRON.."TRON:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheTRON.."TRON:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheTRON.."TRON:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(TheTRON.."TRON:ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheTRON.."TRON:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TheTRON.."TRON:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TheTRON.."TRON:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(TheTRON.."TRON:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheTRON.."TRON:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TheTRON.."TRON:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(TheTRON.."TRON:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheTRON.."TRON:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheTRON.."TRON:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTRON.."TRON:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheTRON.."TRON:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTRON.."TRON:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheTRON.."TRON:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTRON.."TRON:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheTRON.."TRON:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheTRON.."TRON:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheTRON.."TRON:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(TheTRON.."TRON:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTRON.."TRON:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheTRON.."TRON:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheTRON.."TRON:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheTRON.."TRON:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheTRON.."TRON:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheTRON.."TRON:BanGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TheTRON.."TRON:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(TheTRON.."TRON:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheTRON.."TRON:SilentGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TheTRON.."TRON:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(TheTRON.."TRON:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheTRON.."TRON:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(TheTRON.."TRON:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheTRON.."TRON:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheTRON.."TRON:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if not msg.ControllerBot and not Redis:set(TheTRON.."TRON:LeftBot") then
...
Redis:set(TheTRON.."TRON:Lock:text"..msg_chat_id,true) 
...
Redis:set(TheTRON.."TRON:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(TheTRON.."TRON:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(TheTRON.."TRON:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(TheTRON.."TRON:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(TheTRON.."TRON:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(TheTRON.."TRON:Lock:edit"..msg_chat_id,true) 
...
Redis:set(TheTRON.."TRON:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheTRON..'TRON:'..lock..msg_chat_id,"del")    
end
...
Redis:del(TheTRON.."TRON:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(TheTRON.."TRON:Lock:text"..msg_chat_id)  
...
Redis:del(TheTRON.."TRON:Lock:Join"..msg_chat_id)  
...
Redis:del(TheTRON.."TRON:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(TheTRON.."TRON:Lock:tagservr"..msg_chat_id)  
...
Redis:del(TheTRON.."TRON:lockpin"..msg_chat_id)  
...
Redis:del(TheTRON.."TRON:Lock:edit"..msg_chat_id) 
...
Redis:del(TheTRON.."TRON:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TheTRON..'TRON:'..lock..msg_chat_id)    
end
...
Redis:hset(TheTRON.."TRON:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(TheTRON.."TRON:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(TheTRON.."TRON:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(TheTRON.."TRON:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(TheTRON.."TRON:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(TheTRON.."TRON:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:Link"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:User:Name"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:hashtak"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:Cmd"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:Photo"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:Video"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:Animation"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:geam"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:Audio"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:vico"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:Sticker"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:forward"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:Document"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:Contact"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:Spam"..msg_chat_id)  
...
Redis:set(TheTRON.."TRON:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(TheTRON.."TRON:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(TheTRON.."TRON:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(TheTRON.."TRON:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(TheTRON.."TRON:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(TheTRON.."TRON:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(TheTRON.."TRON:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(TheTRON.."TRON:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(TheTRON.."TRON:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
Redis:setex(TheTRON.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(TheTRON.."TRON:Status:Welcome"..msg_chat_id) then
...
Redis:del(TheTRON.."TRON:Welcome:Group"..msg_chat_id) 
...
Redis:setex(TheTRON.."TRON:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(TheTRON.."TRON:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(TheTRON.."TRON:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TheTRON.."TRON:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheTRON.."TRON:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(TheTRON.."TRON:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TheTRON.."TRON:Filter:Group:"..v..msg_chat_id)  
Redis:srem(TheTRON.."TRON:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TheTRON.."TRON:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(TheTRON..'TRON:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(TheTRON..'TRON:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(TheTRON.."TRON:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TheTRON.."TRON:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TheTRON.."TRON:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TheTRON.."TRON:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(TheTRON.."TRON:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(TheTRON.."TRON:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(TheTRON.."TRON:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(TheTRON.."TRON:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(TheTRON.."TRON:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(TheTRON.."TRON:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(TheTRON.."TRON:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(TheTRON.."TRON:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(TheTRON.."TRON:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(TheTRON.."TRON:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(TheTRON.."TRON:Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '- قناة السورس', url = 'https://t.me/JJJJJJTJ'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(TheTRON.."TRON:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheTRON.."TRON:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(TheTRON.."TRON:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TheTRON.."TRON:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheTRON.."TRON:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheTRON.."TRON:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(TheTRON.."TRON:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TheTRON.."TRON:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(TheTRON.."TRON:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(TheTRON.."TRON:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TheTRON.."TRON:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TheTRON.."TRON:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(TheTRON..'TRON:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(TheTRON..'TRON:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(TheTRON..'TRON:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد رسائلك هنا *~ '..(Redis:get(TheTRON..'TRON:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد التعديلات هنا *~ '..(Redis:get(TheTRON..'TRON:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد جهاتك المضافه هنا *~ '..(Redis:get(TheTRON.."TRON:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(TheTRON.."TRON:Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ᥀︙ ارسل الان النص
 ᥀︙ يمكنك اضافه :
...
Redis:del(TheTRON.."TRON:Set:Id:Groups")
...
Redis:setex(TheTRON.."TRON:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
᥀︙ارسل الان النص
᥀︙يمكنك اضافه :
᥀︙`#username` » اسم المستخدم
...
Redis:del(TheTRON.."TRON:Set:Id:Group"..msg.chat_id)
...
Redis:del(TheTRON.."TRON:DevelopersQ:Groups") 
...
Redis:del(TheTRON.."TRON:Developers:Groups") 
...
Redis:del(TheTRON.."TRON:TheBasicsQ:Group"..msg_chat_id) 
...
Redis:del(TheTRON.."TRON:TheBasics:Group"..msg_chat_id) 
...
Redis:del(TheTRON.."TRON:Originators:Group"..msg_chat_id) 
...
Redis:del(TheTRON.."TRON:Managers:Group"..msg_chat_id) 
...
Redis:del(TheTRON.."TRON:Addictive:Group"..msg_chat_id) 
...
Redis:del(TheTRON.."TRON:Distinguished:Group"..msg_chat_id) 
...
Redis:del(TheTRON.."TRON:BanAll:Groups") 
...
Redis:del(TheTRON.."TRON:BanGroup:Group"..msg_chat_id) 
...
Redis:del(TheTRON.."TRON:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(TheTRON.."TRON:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TheTRON.."TRON:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TheTRON.."TRON:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(TheTRON.."TRON:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(TheTRON.."TRON:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(TheTRON.."TRON:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TheTRON.."TRON:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(TheTRON.."TRON:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TheTRON.."TRON:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(TheTRON.."TRON:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(TheTRON.."TRON:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(TheTRON.."TRON:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ⌔"
elseif Redis:get(TheTRON.."TRON:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TheTRON.."TRON:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheTRON.."TRON:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheTRON.."TRON:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(TheTRON.."TRON:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheTRON.."TRON:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheTRON.."TRON:Add:Rd:Sudo:vico"..v)   
Redis:del(TheTRON.."TRON:Add:Rd:Sudo:stekr"..v)     
Redis:del(TheTRON.."TRON:Add:Rd:Sudo:Text"..v)   
Redis:del(TheTRON.."TRON:Add:Rd:Sudo:Photo"..v)
Redis:del(TheTRON.."TRON:Add:Rd:Sudo:Video"..v)
Redis:del(TheTRON.."TRON:Add:Rd:Sudo:File"..v)
Redis:del(TheTRON.."TRON:Add:Rd:Sudo:Audio"..v)
Redis:del(TheTRON.."TRON:Add:Rd:Sudo:video_note"..v)
Redis:del(TheTRON.."TRON:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \n— — — — — — — — —\n"
for k,v in pairs(list) do
if Redis:get(TheTRON.."TRON:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(TheTRON.."TRON:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(TheTRON.."TRON:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(TheTRON.."TRON:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TheTRON.."TRON:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TheTRON.."TRON:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TheTRON.."TRON:Add:Rd:Sudo:File"..v) then
db = "ملف ⌔"
elseif Redis:get(TheTRON.."TRON:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(TheTRON.."TRON:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheTRON.."TRON:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheTRON.."TRON:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(TheTRON.."TRON:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheTRON.."TRON:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheTRON.."TRON:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheTRON.."TRON:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(TheTRON.."TRON:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheTRON..'TRON:GetTexting:DevTheTRON'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheTRON..'TRON:Texting:DevTheTRON')
...
local UserId_Info = LuaTele.searchPublicChat("JJJJJJTJ")
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/iDAbdullah"}
},
{
{text = '❲ 𝖲𝗈𝗎𝗋𝖼𝖾 TRON ❳', url = "https://https://t.me/JJJJJJTJ"},
},
...
if not Redis:get(TheTRON.."TRON:Status:gamle"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(TheTRON.."TRON:Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(TheTRON.."TRON:Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
local T =[[
Welcome to Source : [TRON TEAM.](https://https://t.me/JJJJJJTJ)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'Channel Source ', url = "https://t.me/JJJJJJTJ"},{text = '𝖲𝗈𝗎𝗋𝖼𝖾 TRON', url = "https://https://t.me/JJJJJJTJ"}
},
{
{text = 'Dev Alex. ', url = "https://t.me/xDevAlex"}
},
{
{text = 'Dev Aboud. ', url = "https://https://t.me/iDAbdullah"}
},
}
local msgg = msg_id/2097152/0.5
...
if not Redis:get(TheTRON.."TRON:Sasa:Jeka"..msg_chat_id) then
...
Redis:setex(TheTRON.."TRON:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheTRON.."TRON:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(TheTRON.."TRON:Name:Bot") or "جوكر") then
local NamesBot = (Redis:get(TheTRON.."TRON:Name:Bot") or "جوكر")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
x = x + 1
Redis:srem(TheTRON..'TRON:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,TheTRON)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*᥀︙البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(TheTRON..'TRON:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(TheTRON..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(TheTRON..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(TheTRON..'TRON:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(TheTRON.."TRON:Game:Smile"..msg.chat_id,SM)
...
Redis:set(TheTRON.."TRON:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(TheTRON.."TRON:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(TheTRON.."TRON:Status:Games"..msg.chat_id) then
Redis:del(TheTRON.."TRON:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(TheTRON.."TRON:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TheTRON.."TRON:Status:Games"..msg.chat_id) then
Redis:del(TheTRON.."TRON:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(TheTRON.."TRON:Game:Reflection"..msg.chat_id,name)
...
Redis:set(TheTRON.."TRON:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(TheTRON.."TRON:Game:Difference"..msg.chat_id,name)
...
Redis:set(TheTRON.."TRON:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(TheTRON.."TRON:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TheTRON.."TRON:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TheTRON.."TRON:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(TheTRON.."TRON:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(TheTRON.."TRON:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TheTRON.."TRON:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(TheTRON.."TRON:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
if text == '/start' then
Redis:sadd(TheTRON..'TRON:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(TheTRON.."TRON:Start:Bot") then
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheTRON.."TRON:Name:Bot") or "جوكر")..
...
data = {
{
{text = '᥀ السورس .', url = 'https://t.me/JJJJJJTJ'},{text = '᥀ لتنصيب بوت .', url = 't.me/JJJJJJTJ'}, 
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheTRON.."TRON:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(TheTRON.."TRON:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheTRON.."TRON:Start:Bot") 
...
if not msg.ControllerBot then
if Redis:get(TheTRON.."TRON:TwaslBot") and not Redis:sismember(TheTRON.."TRON:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TheTRON.."TRON:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TheTRON.."TRON:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(TheTRON..'TRON:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'᥀︙تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(TheTRON..'TRON:BaN:In:Tuasl',Info_User)  
...
Redis:srem(TheTRON.."TRON:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(TheTRON..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TheTRON.."TRON:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTRON.."TRON:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(TheTRON.."TRON:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTRON.."TRON:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TheTRON.."TRON:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTRON.."TRON:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TheTRON.."TRON:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTRON.."TRON:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TheTRON.."TRON:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTRON.."TRON:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TheTRON.."TRON:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTRON.."TRON:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TheTRON.."TRON:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTRON.."TRON:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TheTRON.."TRON:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTRON.."TRON:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(TheTRON.."TRON:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheTRON.."TRON:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(TheTRON.."TRON:Lock:tagservr"..data.message.chat_id) then
...
if Message_Edit.sender.user_id == TheTRON then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(TheTRON..'TRON:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TheTRON.."TRON:Lock:edit"..data.chat_id) then
...
if tonumber(listYt[1]) == tonumber(IdUser) then
Redis:srem(TheTRON.."TRON:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(TheTRON.."TRON:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:del(TheTRON.."TRON:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(TheTRON.."TRON1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(TheTRON.."TRON:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TheTRON.."TRON:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheTRON.."TRON:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheTRON.."TRON1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheTRON.."TRON:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheTRON.."TRON:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(TheTRON.."TRON:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheTRON.."TRON:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheTRON.."TRON:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheTRON.."TRON:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheTRON.."TRON:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Sasa:Jeka"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheTRON.."TRON:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheTRON.."TRON:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheTRON.."TRON:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TheTRON.."TRON:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheTRON..'TRON:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TheTRON.."TRON:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheTRON.."TRON:SilentGroup:Group"..ChatId) 
